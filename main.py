...
def main():
    ...
    banowati.update(bunker_value=360.00, bunker_level=945, OPEX=2_123_842, current_port='Mina Saqr', layover_start_week=0)
    gdynia.update(bunker_value=313.00, bunker_level=1134, OPEX=2_150_240, current_port='Shanghai', layover_start_week=0)
